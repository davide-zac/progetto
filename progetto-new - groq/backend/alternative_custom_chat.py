...
import json
import logging
from prompts import content
# Configura il logging
logging.basicConfig(level=logging.DEBUG)


class CustomLLM(LMStudio):
    def chat(self, messages: List[ChatMessage], content=content, stream: bool = False, timeout: float = 300.0) -> str:
...
def custom_chat(llm: CustomLLM, text: str) -> str:
    ...
    messages = [
        ChatMessage(
            ...
            content="Transform this text to follow the rules for better DSA readability:\n\n"+text,
        ),
    ]
